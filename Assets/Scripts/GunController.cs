...
public class GunController : MonoBehaviour
{
    ...
    public void CancelFineSight()
    {
            ...
            while (currentGun.transform.localPosition != currentGun.fineSightOriginPos)
        {
            ...
            currentGun.muzzleFlash.transform.localPosition = Vector3.Lerp(currentGun.muzzleFlash.transform.localPosition, currentGun.muzzleFlash.transform.localPosition+temp,0.05f);
            yield return null;
            }
        }
